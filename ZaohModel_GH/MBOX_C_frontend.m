...
% %%%% mixing coefficient (Sv) after Mingyu
...
pars.d13c_atm_0    = -7 ;
pars.d13c_DIC_p_0  = 0.5 ;
pars.d13c_DIC_di_0 = 0.5 ;
pars.d13c_DIC_s_0  = 0.5 ;
pars.d13c_DIC_h_0  = 0.5 ;
pars.d13c_DIC_d_0  = 0.5 ;
...
pars.k_phosw0 = 0.0967e12; %Slomp and van Cappellen, 2007



%%%% riverine solid FeIII fluxes, mol yr-1 %% 
%%%% already included in the weathered FeIII input (FeIIIw)
pars.sFeIII_p0 = 190e9;
pars.sFeIII_di0 = 70e9;
pars.sFeIII_d0 =  50e9;

pars.k_FeIIIw0 = 2e9; %% modern rates from Tagliabue et al., 2015
% 
% pars.k_FeIIIw0 = 440e9; %% total Fe input from Raiswell et al., 2006 = 35
% Tg Fe/a
...
pars.startstate(61) = 0 ;
pars.startstate(62) = 0 ;
...
%%%%%%% run the system
[rawoutput.T,rawoutput.Y] = ode15s(@MBOX_C_equations_github,[pars.whenstart pars.whenend],pars.startstate,options);
