...
%% Options
when.start = -300e6 ; %Start time
when.end = 0; %End time
stepnumber = 1 ;

%%% Run parameters
per.sig_SCAV = 0; %Scavenging - percentage of upwelled that is scavenged
per.POP_deep_feedback = 1;%Percentage of POP burial that is redox dependent, normal (0.25), strong (0.5)
per.CaP_deep_feedback = 1;%Percentage of Pauth burial that is redox dependent normal (0.5), strong (0.9)
% per.POP_deep_feedback = 0.5;%Percentage of POP burial that is redox dependent
% per.CaP_deep_feedback = 0.9;%Percentage of Pauth burial that is redox dependent
pars.CPoxic = 106 ;
